    ...
    <div class="container mx-auto px-4">
          ...
          <section class="py-12 px-4 text-center">
            <div class="w-full max-w-2xl mx-auto"><span class="text-sm font-semibold">TAGLINE</span>
              <h2 class="text-5xl mt-2 mb-6 leading-tight font-heading">No paper plane can be made without paper</h2><a class="text-blue-700 hover:underline" href="#">Learn more &raquo;</a>
            </div>
          </section>
          ...
          <section class="py-12 px-4">
            ...
            <div class="flex flex-wrap -mx-4">
              ...
              <div class="w-full lg:w-1/3 px-4 mb-8 lg:mb-0">
                <div class="h-full pb-8 rounded shadow-md"><a href="#"><img class="mb-4" src="placeholders/pictures/office.jpg" alt="">
                    <div class="px-6"><small>22 Oct 2019 | By Dwight K. Schrute</small>
              ...
              <div class="w-full lg:w-1/3 px-4 mb-8 lg:mb-0">
                <div class="h-full pb-8 rounded shadow-md"><a href="#"><img class="mb-4" src="placeholders/pictures/work.jpg" alt="">
                    <div class="px-6"><small>22 Oct 2019 | By Jim Halpert</small>
