  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap -m-12">
      <div class="p-12 md:w-1/2 flex flex-col items-start">
        <span class="inline-block py-1 px-3 rounded bg-orange-100 text-orange-500 text-sm font-medium tracking-widest">CATEGORY</span>
      ...
      <div class="p-12 md:w-1/2 flex flex-col items-start">
        <span class="inline-block py-1 px-3 rounded bg-orange-100 text-orange-500 text-sm font-medium tracking-widest">CATEGORY</span><span class="mt-1 text-gray-500 text-sm">12 Jun 2019</span>
